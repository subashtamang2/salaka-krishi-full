...
export default function MultiFileUpload({ error, showList = false, files, type, setFieldValue, sx }: UploadMultiFileProps) {
    const { getRootProps, getInputProps, isDragActive, isDragReject, fileRejections } = useDropzone({
        ...
        onDrop: (acceptedFiles: CustomFile[]) => {
            try {
                ...
                const updatedFiles = Array.isArray(files) ? [...files, ...newFiles] : newFiles;
